...
The graphs can be loaded from the networkx graph files in the following way:
...
reducer = umap.UMAP(
    n_neighbors = 50, min_dist=0.01, n_components=2, n_epochs = 500
)
...
```{python}
feature_names = [
    'svclass_DEL', 'svclass_DUP','svclass_TRA', 
    'svclass_h2hINV', 'svclass_t2tINV','ins_len', 
    'mh_len', 'rep_time_breakend1', 'gc_breakend1',
